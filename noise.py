...
def generate_perlin_noise_2d(
    ...
    Generates a multiple octave perline mask
    """
...
def cutout_noise(
        ...
        radius: int = 100,
        radius_scale_factor: float = 0.6,
    ):
    """Creates oval/elliptical noise regions to simulate bigger gaps in the text
    """
...
def warp_mask(
    ...
    """Warps the scrolls and line_masks to simulate character and line bending
    """
...
class Noise:
    ...
    def create_masks(self, N: int = 10):
        """Expensive operation call only few times during training, potentially only once. Creates the perlin textures and their rotated augmentation
        """
    ...
    def damage(self, images: np.ndarray, strength: float = 0.2):
        """Cheaper operation, damages the scrolls based on the perlin texture
        """
