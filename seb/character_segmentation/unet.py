...
class UNet(nn.Module):
    def __init__(self, num_classes=27, base_ch=32):  # Reduced base_ch from 64 to 32
        super().__init__()
        ...
        self.up4  = nn.ConvTranspose2d(base_ch*16, base_ch*8, kernel_size=2, stride=2, output_padding=(1,1))
        self.dec4 = self.conv_block(base_ch*16, base_ch*8)

        self.up3  = nn.ConvTranspose2d(base_ch*8, base_ch*4, kernel_size=2, stride=2, output_padding=(0,1))
    ...
    def conv_block(self, in_ch, out_ch):
        return nn.Sequential(
            ...
            nn.ReLU(inplace=True)  # faster than LeakyReLU and reduces overhead
        )
